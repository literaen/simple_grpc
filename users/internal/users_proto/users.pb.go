...
import (
	tasks_proto "github.com/literaen/simple_grpc/tasks/internal/tasks_proto"
...
type GetUserResponse struct {
	...
	Tasks         []*tasks_proto.Task    `protobuf:"bytes,2,rep,name=tasks,proto3" json:"tasks,omitempty"` // Используем Task из другого proto
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetUserResponse) GetTasks() []*tasks_proto.Task {
	if x != nil {
		return x.Tasks
	}
	return nil
...
const file_users_proto_rawDesc = "" +
	...
	"\n" +
	"UpdateUser\x12\x1e.users_proto.UpdateUserRequest\x1a\x1f.users_proto.UpdateUserResponseB<Z:github.com/literaen/simple_grpc/users/internal/users_protob\x06proto3"
...
var file_users_proto_goTypes = []any{
	...
	(*tasks_proto.Task)(nil),    // 11: tasks_proto.Task
}
