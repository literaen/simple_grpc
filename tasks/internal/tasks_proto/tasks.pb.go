...
const file_tasks_proto_rawDesc = "" +
	...
	"\n" +
	"DeleteTask\x12\x1e.tasks_proto.DeleteTaskRequest\x1a\x1f.tasks_proto.DeleteTaskResponseB<Z:github.com/literaen/simple_grpc/tasks/internal/tasks_protob\x06proto3"
